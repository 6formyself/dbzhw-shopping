...
public class LogAspectServiceApi {
    ...
    /**
     * 申明一个切点里面是execution表达式,所有该表达式中的方法都会打印请求日志
     */
    @Pointcut("execution(public * com.dbzhw.api.service.*.*(..))")
    private void controllerAspect() {
    }

    /**
     * 请求method前打印内容,打印的是请求内容,包括请求参数,请求方法,请求方式
     *
     * @param joinPoint
     */
